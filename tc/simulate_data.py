"""Simulates MCMC model data: pick the true parameter variables from the model's prior distribution."""
import numpy as np
import numpy.matlib
...
def generate_response_times(num_persons, num_items):
    ...
    return np.exp(np.random.normal(beta_j - tau_i, 1/alpha_j ** 2, size=(num_persons, num_items)))
